...
bool BezierCurve2D::getPoint(double t, null_space_optimization::CartersianTrajectory& msg) {
    if (t <= tHit_) {
...
vector<null_space_optimization::CartersianTrajectory> BezierCurve2D::getTrajectory(double stepSize) {
