...
BezierHit::BezierHit(Vector2d bound_lower, Vector2d bound_upper, double height) {
...
//}
//
//bool BezierHit::getPoint(double t, null_space_optimization::CartersianTrajectory& msg) {
//    if (t <= tHit_) {
...
//}
//
//vector<null_space_optimization::CartersianTrajectory> BezierHit::getTrajectory(double stepSize) {
//    vector<null_space_optimization::CartersianTrajectory> trajectory;
